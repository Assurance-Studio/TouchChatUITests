...
class MainPage {
    ...
    let lampWFL1Hit: XCUIElement
    let lampWFLFull: XCUIElement
    let lampWFLTransition: XCUIElement
    let spanish1Hit: XCUIElement
    let french1Hit: XCUIElement
    ...
    init(app: XCUIApplication, vocabName: String) {
        ...
        // Copy a Vocab Elements
        lampWFL1Hit = app.staticTexts["LAMP WFL - English 1-Hit"]
        lampWFLFull = app.staticTexts["LAMP WFL - English Full"]
        lampWFLTransition = app.staticTexts["LAMP WFL - English Transition"]
        spanish1Hit = app.staticTexts["LAMP WFL - Español Completo"]
        french1Hit = app.staticTexts["LAMP WFL – Français Complet"]
    ...
    func copyLampWflHit(vocabName: String, vocabDescription: String) {
        copyVocab(vocabType: lampWFL1Hit, vocabName: vocabName, vocabDescription: vocabDescription)
    }
    
    func copyLampWflFull(vocabName: String, vocabDescription: String) {
        copyVocab(vocabType: lampWFLFull, vocabName: vocabName, vocabDescription: vocabDescription)
    }
    
    func copyLampWflTransition(vocabName: String, vocabDescription: String){
        copyVocab(vocabType: lampWFLTransition, vocabName: vocabName, vocabDescription: vocabDescription)
    }
    
    func copySpanish1Hit(vocabName: String, vocabDescription: String){
        copyVocab(vocabType: spanish1Hit, vocabName: vocabName, vocabDescription: vocabDescription)
    }
    
    func copyFrench1Hit(vocabName: String, vocabDescription: String){
        copyVocab(vocabType: french1Hit, vocabName: vocabName, vocabDescription: vocabDescription)
    }
