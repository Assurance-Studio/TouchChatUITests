...
<<<<<<< HEAD:Tests/MenuFunctionality/copyPasteButtonFunctionalitiesTests.swift
        pages.openTheSettingsTab()
        pages.ensureAllowDeleteIsOn()
=======
        profilesAndEditingPage.openTheSettingsTab()
        profilesAndEditingPage.ensureAllowDeleteIsOn()
>>>>>>> ip_june2025:apps/TouchChatUITests/Tests/MenuFunctionality/copyPasteButtonFunctionalitiesTests.swift
