...
<<<<<<< HEAD:Tests/ButtonActions/CreateButtonActions/createButtonOpenGoogleAppsTests.swift
        pages.openTheSettingsTab()
        pages.ensureAllowDeleteIsOn()
=======
        profilesAndEditingPage.openTheSettingsTab()
        profilesAndEditingPage.ensureAllowDeleteIsOn()
>>>>>>> ip_june2025:apps/TouchChatUITests/Tests/ButtonActions/CreateButtonActions/createButtonOpenGoogleAppsTests.swift
