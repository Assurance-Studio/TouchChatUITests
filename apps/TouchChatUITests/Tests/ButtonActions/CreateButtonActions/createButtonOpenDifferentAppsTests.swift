...
<<<<<<< HEAD:Tests/ButtonActions/CreateButtonActions/createButtonOpenDifferentAppsTests.swift
        pages.openTheSettingsTab()
        pages.ensureAllowDeleteIsOn()
=======
        profilesAndEditingPage.openTheSettingsTab()
        profilesAndEditingPage.ensureAllowDeleteIsOn()
>>>>>>> ip_june2025:apps/TouchChatUITests/Tests/ButtonActions/CreateButtonActions/createButtonOpenDifferentAppsTests.swift
